    ...
    <div id="main-content">
        <div id="inner-content">
        	<h1 class="page-title">
				<?php
                    if ( is_day() ) :
                        printf( __( 'Daily Archives: %s', 'eatery' ), get_the_date() );
    
                    elseif ( is_month() ) :
                        printf( __( 'Monthly Archives: %s', 'eatery' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'eatery' ) ) );
    
                    elseif ( is_year() ) :
                        printf( __( 'Yearly Archives: %s', 'eatery' ), get_the_date( _x( 'Y', 'yearly archives date format', 'eatery' ) ) );
    
                    elseif ( is_category() ) :
                        printf( __( '%s', 'eatery' ), single_cat_title( '', false ) );
